  ...
  return (
    <div className="rounded-xl p-6 border border-[#E5E5E5]">
      ...
      <div className="flex items-center gap-2 mb-4">
        <div className="flex flex-1 flex-col justify-start items-start bg-white rounded-xl px-4 py-2 border border-[#E5E5E5]">
          <span className="text-xs text-gray-600">Total Projects</span>
          <span className="text-2xl font-bold text-gray-900">{data?.projects?.total_projects || 0}</span>
        </div>
        <div className="flex flex-1 flex-col justify-start items-start bg-white rounded-xl px-4 py-2 border border-[#E5E5E5]">
          <span className="text-xs text-gray-600">Active Projects</span>
          <span className="text-2xl font-bold text-gray-900">{data?.projects?.active || 0}</span>
        </div>
      </div>
